...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6364708291:AAHybaK0wGxzjl5o43p1lyuMIBoaTdzVNDo')
if len(BOT_TOKEN) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002414431472').split()]
if len(INDEX_CHANNELS) == 1:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002237896833')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://kfcinemas:kfcinemas1111@kfcinemas.wstsv.mongodb.net/?retryWrites=true&w=majority&appName=kfcinemas")
...
LANGUAGES = [language.lower() for language in environ.get('LANGUAGES', 'kannada').split()]
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002247389402")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://fashionable-dodi-kfcinemasstore-cc6f1fec.koyeb.app/")
if len(URL) == 0:
